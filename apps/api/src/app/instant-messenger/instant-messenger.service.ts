...
import { UserApplicationsResponseDto } from './dto/user-applications-response.dto';

@Injectable()
export class InstantMessengerService {
  private readonly logger = new Logger(InstantMessengerService.name);
  ...
  async getUserApplications(
    ...
    return this.request<UserApplicationsResponseDto>(
      MethodsEnum.GET,
